                        ...
                        <tr>
                            ...
                            <td>
                                <div className="d-flex align-center">
                                    <Button onClick={() => dispatch({type: ACTION_TYPES.DECREASE_CART_ITEM, payload: item._id})}><i
                                        className="fa fa-minus"/></Button>
                                    <span>{item.quantity}</span>
                                    <Button onClick={() => dispatch({type: ACTION_TYPES.INCREASE_CART_ITEM, payload: item._id})}><i
