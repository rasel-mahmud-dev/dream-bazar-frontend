    ...
    return (
        <div className="">
            ...
            <div className="category-section">
                {sectionProducts && Array.isArray(sectionProducts) && sectionProducts.map(category => (
                    <div className="category-item">
                        <div>
                            {category.logo ? <img src={staticImagePath(category.logo)} alt=""/> : <span className="missing-image-text">Category</span>}
                        </div>
                        <h4>{category.name}</h4>
                    </div>
                ))}
