...
import {BiChevronsDown, BiSearch, BiUser,} from "react-icons/bi";

import {AiOutlineUser,} from "react-icons/ai";

import {FaFacebook, FaLanguage, FaSignInAlt,} from "react-icons/fa";
...
function Navigation(props) {
    ...
    function handleToggleLeftBar() {
        let where = location.pathname.startsWith("/p/")
            ? "filter-sidebar"
            : location.pathname.startsWith("/dashboard")
                ? "customer-dashboard"
                : "home"
        dispatch(setOpenLeftSidebar(where))
    }
            ...
            <div ref={headerRef} className={["navigation", isFixed ? "nav_fixed" : ""].join(" ")}>
                ...
                <div className="top-navigation">
                    <div className="grid grid-cols-12 justify-between w-full max-w-8xl mx-auto px-4">
                        ...
                        <div className="col-span-2 flex w-full gap-x-4">
                            <li className="top-nav-select flex items-center justify-end dark:text-white">
                ...
                <div className="main-nav ">
                    <div className="max-w-8xl mx-auto px-4 flex items-center">
                        <div className="hambargar-menu-icon block mr-3 ">
