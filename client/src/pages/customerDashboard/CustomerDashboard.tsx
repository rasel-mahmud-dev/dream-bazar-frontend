...
import {FaAddressBook, FaIcons, FaQuestionCircle, FaSignOutAlt} from "react-icons/fa";
import {GoReport} from "react-icons/go";
import {GiCancel, GiHelp, GiReturnArrow} from "react-icons/gi";
...
const CustomerDashboard = (props) => {
    ...
    const {authState: {auth}, appState: {openLeftSidebar}} = useAppSelector(state => state)
    ...
    return (
        <div className="">
            <div className="mx-auto">
                <div className="flex">
                    <DashboardSidebar sidebarData={sidebarLinks} isOpen={openLeftSidebar === "customer-dashboard"} auth={auth}/>
