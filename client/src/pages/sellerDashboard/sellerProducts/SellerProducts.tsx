        ...
        },
        {
            ...
            render: (_, product) => (
                <div className="flex gap-x-3">
                    ...
                    <Box className="border border-red-500" onClick={() => handleDeleteProduct(product._id)}><FaTrash
                        className="text-red-500 text-xs"/></Box>
                </div>
            ),
        },
    ];
        ...
        <div className="m-4">
            <div className="">
                <h1 className="heading-4 flex items-center gap-x-2">
                    All Products
                    <Badge className="!text-xs bg-gray-100">{products?.length}</Badge>
                </h1>
