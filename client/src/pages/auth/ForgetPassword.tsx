...
const ForgetPassword = () => {
	...
	return (
		...
		<div className="max-w-8xl mx-auto px-4 h-screen">
			...
			<div
				className="max-w-md mx-auto bg-white p-5 card rounded-2xl absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
				<div>
					<h1 className="text-green-450 text-2xl font-bold text-center">Forget Password</h1>
					
					<p className="py-4 text-center text-neutral-400 ">We will send you a mail with a otp code and link. This link or otp code make your account verifiyed.</p>
	                ...
	                />
						<div className="flex justify-between items-stretch mt-4 gap-x-4">
			                ...
			                <InputGroup
				                className="mt-0 mb-0"
				                type="number"
				                state={state.userData} name="result"
				                onChange={handleChange}
							...
							<div className="bg-green-500/10 flex rounded-md justify-center items-center gap-x-1">
								<p className="text-xl font-semibold text-red-500">4</p>
								<p className="text-xl font-semibold text-blue-500">2</p>
								<p className="text-xl font-semibold text-fuchsia-500">1</p>
								<p className="text-xl font-semibold text-pink-500">3</p>
							</div>
						...
						<div className="my-4">
							<Link className="text-right text-link" to="/">Have a OTP code </Link>
						</div>
			        <button
				        className="w-full bg-green-450 px-4 py-2 border-none text-white font-semibold text-lg rounded-xl">Send Mail</button>
				</form>
					<Link to="/auth/join/login"
					      className='font-medium !text-green-500 text-link '>
				<p className='text-center mb-4 mt-6'>Back to login page </p> </Link>
